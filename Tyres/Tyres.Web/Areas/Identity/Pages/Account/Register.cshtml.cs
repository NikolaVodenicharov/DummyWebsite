...
namespace Tyres.Web.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        {
            [Required, MinLength(FirstNameMinLength), MaxLength(FirstNameMaxlength)]
            public string FirstName { get; set; }

            [Required, MinLength(LastNameMinLength), MaxLength(LastNameMaxlength)]
            public string LastName { get; set; }

            [Required, MinLength(DeliveryAddressMinlenght), MaxLength(DeliveryAddressMaxlenght)]
